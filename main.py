...
from exponentialfunction import calculate_and_plot_exponential, reset_exponential # Import functions
...
def open_exponential_window():
    exponential_window = Toplevel(window)
    exponential_window.geometry("700x550")
    exponential_window.configure(bg="#FFE873")
    exponential_window.title("Exponential Equations")

    # Create a canvas for the new window
    exponential_canvas = Canvas(
        exponential_window,
        bg="#FFE873",
        height=550,
        width=700,
    ...
    exponential_canvas.place(x=0, y=0)

    # Add the same UI elements as in the main window
    exponential_canvas.create_rectangle(
        0.0,
        0.0,
        700.0,
        94.0,
    ...
    exponential_canvas.create_text(
        17.0,
        12.0,
        anchor="nw",
    ...
    image_image_1_resized = ImageTk.PhotoImage(image_1_resized)
    window.image_image_1_resized = image_image_1_resized
    image_1 = exponential_canvas.create_image(
        225.0,
        283.0,
        image=image_image_1_resized,
        tags="default_image"
    ...
    image_image_2_resized = ImageTk.PhotoImage(image_resized)
    window.image_image_2 = image_image_2_resized
    image_2 = exponential_canvas.create_image(
        560.0,
        283.0,
        image=image_image_2_resized
    )
    ...
    button_1 = Button(
        ...
        bg="#2196F3",
        fg="white",
        command=lambda: calculate_and_plot_exponential(entry_1, exponential_canvas, result_label)
    )
    button_1.place(
        x=359.0,
        y=460.0,
    ...
    button_2 = Button(
        ...
        bg="#2196F3",
        fg="white",
        command=lambda: reset_exponential(entry_1, exponential_canvas, result_label)
    )
    button_2.place(
        x=459.0,
        y=460.0,
    ...
    # Add a result label
    result_label = exponential_canvas.create_text(
        540, 280,
        text="",
        fill="black",
        font=("Arial", 7)
